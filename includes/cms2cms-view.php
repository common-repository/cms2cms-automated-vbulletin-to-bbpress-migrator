<?php
if (!defined('CMS2CMS_VBULLETIN_VERSION')) {
    die();
}
...
$ajaxNonce        = $dataProvider->getFormTempKey('cms2cms-vBulletinBb-ajax-security-check');
$currentPluginUrl = plugin_dir_url(__FILE__);
$jsConfig         = $dataProvider->getConfig(true);
$config           = $dataProvider->getConfig();
$loader           = new CmsBridgevBulletinBbLoader();

$styles = array($dataProvider->getFrontUrl() . 'css/cms2cms.css?v=' . CMS2CMS_VBULLETIN_VERSION);
foreach ($styles as $style) {
    printf('<link rel="stylesheet" href="%s" type="text/css" media="all">', $style);
}

$scripts = array(
    $dataProvider->getFrontUrl() . 'js/jsonp.js?v=' . CMS2CMS_VBULLETIN_VERSION,
    $dataProvider->getFrontUrl() . 'js/cms2cms.js?v=' . CMS2CMS_VBULLETIN_VERSION
);
...
?>
<div class="wrap cms2cms-vBulletinBb-wrapper">
    <div class="cms2cms-vBulletinBb-container">
        <div class="cms2cms-vBulletinBb-header">
        ...
        <?php if ($activated) { ?>
            <script language="JavaScript">
                jQuery('.cms2cms-vBulletinBb-container').addClass('cms2cms_vBulletinBb_is_activated');
            </script>
            <div class="cms2cms-vBulletinBb-message">
                <span>
                    <?php echo sprintf(
                        $dataProvider->__('You are logged in CMS2CMS as %s', $fileStart),
                        get_option('cms2cms-vBulletinBb-login')
                    ); ?>
                </span>
                <div class="cms2cms-vBulletinBb-logout">
                    <form action="" method="post" id="logout" data-logout="<?php echo $dataProvider->getLogOutUrl() ?>">
                        <input type="hidden" name="cms2cms_vBulletinBb_logout" value="1"/>
                        <input type="hidden" name="_wpnonce"
                               value="<?php echo $dataProvider->getFormTempKey('cms2cms_vBulletinBb_logout') ?>"/>
                        <button class="button-grey cms2cms-vBulletinBb-button" data-log-this="Logout" type="button">
        ...
        <?php } ?>
        <div class="cms2cms-vBulletinBb-plugin">
            <div id="cms2cms_vBulletinBb_accordeon">
                ...
                <?php
                $cms2cms_vBulletinBb_step_counter = 1;
                if (!$activated) { ?>
                    <div id="cms2cms_vBulletinBb_accordeon_item_id_<?php echo $cms2cms_vBulletinBb_step_counter++; ?>"
                         class="step-body cms2cms_vBulletinBb_accordeon_item cms2cms_vBulletinBb_accordeon_item_register">
                        ...
                        <form action="<?php echo $dataProvider->getLoginUrl() ?>"
                              ...
                              class="step_form"
                              id="cms2cms_vBulletinBb_form_register">
                            <div class="center-content">
                                <div class="error_message"></div>
                                <div class="user-name-block" style="display: none">
                                    <label
                                            for="cms2cms-vBulletinBb-user-name"><?php $dataProvider->_e('Full Name', $fileStart); ?></label>
                                    <input type="text" maxlength="50" id="cms2cms-vBulletinBb-user-name" name="name"
                                           value="" placeholder="Your name" class="regular-text"/>
                                    <div class="cms2cms-vBulletinBb-error name">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-vBulletinBb-user-email"><?php $dataProvider->_e('Email', $fileStart); ?></label>
                                    <input type="text" id="cms2cms-vBulletinBb-user-email" name="email"
                                           value="" placeholder="Your email" class="regular-text"/>
                                    <div class="cms2cms-vBulletinBb-error email">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>
                                <div>
                                    <label
                                            for="cms2cms-vBulletinBb-user-password"><?php $dataProvider->_e('Password', $fileStart); ?></label>
                                    <input type="password" id="cms2cms-vBulletinBb-user-password" name="password" value=""
                                           placeholder="Your password" class="regular-text"/>
                                    <div class="cms2cms-vBulletinBb-error password">
                                        <div class="error-arrow"></div>
                                        <span></span></div>
                                </div>

                                <input type="hidden" id="cms2cms-vBulletinBb-user-plugin" name="referrer"
                                       value="<?php echo $dataProvider->getPluginReferrerId(); ?>"
                                       class="regular-text"/>
                                <input type="hidden" id="cms2cms-vBulletinBb-site-url" name="siteUrl"
                                ...
                                <button
                                        ...
                                        type="button" id="auth_submit" class="cms2cms-vBulletinBb-button button-green">
                                ...
                                <a data-log-this="Forgot Password Link clicked"
                                   ...
                                   class="cms2cms-vBulletinBb-real-link" >
                ...
                <?php } /* cms2cms_vBulletinBb_is_activated */ ?>
                ...
                <div id="cms2cms_vBulletinBb_accordeon_item_id_<?php echo $cms2cms_vBulletinBb_step_counter++; ?>"
                     class="step-body cms2cms_vBulletinBb_accordeon_item">
                    <?php if (isset($message)) {?>
                        <div class="container-erorr-1">
                            <div class="block-erorr alert r-b-e">
                                <?php $dataProvider->_e(sprintf('%s Please contact our', $message), $fileStart); ?>
                    ...
                    <form action="<?php echo $dataProvider->getWizardUrl(); ?>"
                          method="post"
                          id="cms2cms_vBulletinBb_form_estimate">
                        <div class="center-content">
                            <div class="error_message"></div>
                            <div id='error'></div>
                            <p>
                            ...
                            <div>
                                ...
                                <input type="text" id="sourceUrl" name="sourceUrl" value="" class="regular-text"
                                       ...
                                       ?>"/>
                                <div class="cms2cms-vBulletinBb-error">
                                    <div class="error-arrow"></div>
                                    <span></span></div>
                            </div>
                            ...
                            <input type="hidden" id="key" name="key"
                                   value="<?php echo $key; ?>"/>
                            <button id="verifySource_vBulletinBb"
                                    data-log-this="Verify Source Button pressed"
                                    type="button" name="verify-source" class="cms2cms-vBulletinBb-button button-green">
                                <?php $dataProvider->_e('Verify Connection', $fileStart); ?>
                            </button>
                        </div>
                    </form>
                    <div class="cms2cms-vBulletinBb-error"></div>
                </div>
            </div>
        </div> <!-- /plugin -->
